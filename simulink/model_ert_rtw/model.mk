...
## 
## Makefile     : model.mk
## Generated on : Tue Jun 25 15:36:44 2024
...
START_DIR                 = C:\Users\DELL\Desktop\Cmake\VP_SIM\PUTM_VP_SIM\simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=model -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\model_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\model_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\model_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\model_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\model_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\model_ert_rtw\ert_main.c"


model.obj : "$(START_DIR)\model_ert_rtw\model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\model_ert_rtw\model.c"


model_data.obj : "$(START_DIR)\model_ert_rtw\model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\model_ert_rtw\model_data.c"
